...
int main() {
    ...
    printf("value of any quantity of the ");
    ...
    char str1[5]="mass",str2[17];
    char str3[6]="force",str4[5]="time";
    char str5[9]="velocity";
    char str6[18]="previous velocity";
    char str7[16]="acceleration";
